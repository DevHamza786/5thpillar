...
class SiteNavigationService
{
        ...
        return $rows->where('parent_id', $parentId)->values()->map(function (NavMenuItem $item) use ($rows, $isHome, $currentSlug, $isNewsSection) {
            ...
            switch ($item->link_type) {
                case NavMenuItem::LINK_HOME:
                    $node['url'] = route($this->urdu->namedRoute('home'));
                    if ($isHome) {
                        $node['active'] = true;
                    }
                    break;
                ...
                case NavMenuItem::LINK_NAMED_ROUTE:
                    if ($item->route_name) {
                        ...
                        if ($this->urdu->isUrduLocale() && ! str_starts_with($routeName, 'urdu.')) {
                            $routeName = 'urdu.'.$routeName;
                        }
                        $node['route'] = $routeName;
    ...
    private function legacyMenu(bool $isHome, string $currentSlug, bool $isNewsSection): array
    {
        return [
            [
                'label' => __('Home'),
                'url' => route($this->urdu->namedRoute('home')),
                'active' => $isHome,
            ],
            [
                'label' => __('Company'),
                'children' => [
                    ...
                    ['label' => 'PACRA Rating', 'url' => PublicPath::uploadHref('assets/pdf/company/IFS-Rating-of-5th-Pillar-Family-Takaful-Limited.pdf'), 'external' => true],
                    ['label' => 'Code of Conduct', 'url' => PublicPath::uploadHref('assets/pdf/company/Code-of-Conduct-Corporate.pdf'), 'external' => true],
                    ['label' => 'Waqf Deed', 'url' => PublicPath::uploadHref('assets/pdf/company/Waqf-Deed-with-addition-of-Amendment-2-4-26.pdf'), 'external' => true],
                    ['label' => 'PTF Policies', 'url' => PublicPath::uploadHref('assets/pdf/company/PTF-Policies.pdf'), 'external' => true],
            ...
            [
                ...
                'children' => [
                    ...
                    ['label' => __('Hajj Planner'), 'route' => $this->urdu->namedRoute('hajj-planner.index')],
                    ['label' => __('Umrah Planner'), 'route' => $this->urdu->namedRoute('umrah-planner.index')],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'children' => [
                            ['label' => 'Notice of AGM 2026', 'url' => PublicPath::uploadHref('assets/pdf/investors/Notice-of-AGM-2026.pdf'), 'external' => true],
                            ['label' => 'Notice of EoGM 2025', 'url' => PublicPath::uploadHref('assets/pdf/investors/Notice-of-EoGM-2025.pdf'), 'external' => true],
                            ['label' => 'Notice of AGM 2025', 'url' => PublicPath::uploadHref('assets/pdf/investors/Notice-of-AGM-2025.pdf'), 'external' => true],
                        ],
                    ],
                    ...
                    [
                        ...
                        'children' => [
                            ['label' => 'Target Asset Mix and Charges', 'url' => PublicPath::uploadHref('assets/pdf/funds/web-page.pdf'), 'external' => true],
            ...
            [
                'label' => __('Downloads'),
                'children' => [
                    ['label' => 'List of Participants Having Unclaimed / Un-Enchased Benefits', 'url' => PublicPath::uploadHref('assets/pdf/investors/Unclaimed-Un-Enchased-Benefits-lIst-March-2026.pdf'), 'external' => true],
