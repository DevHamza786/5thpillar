    @unless ($isHome || $useStructuredInnerChrome)
        <div class="sc_layouts_row sc_layouts_row_type_normal scheme_dark laravel-page-header-row">
            <div class="content_wrap">
                <div class="sc_layouts_title with_content">
                    <div class="sc_layouts_title_content">
                        <div class="sc_layouts_title_title">
                            <h1 class="sc_layouts_title_caption">{{ $pageTitle }}</h1>
                        </div>
                        <div class="sc_layouts_title_breadcrumbs">
                            <div class="breadcrumbs">
                                <a class="breadcrumbs_item home" href="{{ route($homeRoute ?? 'home') }}">{{ __('Home') }}</a>
                                <span class="breadcrumbs_delimiter"></span>
                                <span class="breadcrumbs_item current">{{ $pageTitle }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="menu_mobile menu_mobile_fullscreen scheme_dark">
    <div class="menu_mobile_inner">
        <a class="menu_mobile_close icon-cancel" href="#" aria-label="Close mobile menu"></a>
        <a class="sc_layouts_logo" href="{{ route($homeRoute ?? 'home') }}">
            <img src="{{ $logoUrl }}" alt="5th Pillar Takaful" width="230" height="81">
        </a>

        <div class="menu_mobile_lang icons">
            <a href="{{ $englishUrl }}" class="facebook">English</a>
            @if ($urduLocaleEnabled ?? true)
