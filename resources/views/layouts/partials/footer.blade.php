    ...
    <div class="laravel-footer-main">
        <div class="content_wrap">
            <div class="laravel-footer-brand">
                <img src="{{ asset('uploads/2017/2017/07/5th-pilar-logo-64d5d6041dbd1.webp') }}" alt="5th Pillar Takaful Logo" width="230" height="81">
            </div>
            ...
            <div class="laravel-footer-grid">
                <div class="footer-widget widget widget_nav_menu">
                    ...
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('pages.show', ['slug' => 'knowledge-centre']) }}">Knowledge Centre</a></li>
                        <li><a href="{{ route('pages.show', ['slug' => 'online-complaint-form']) }}">Complaint Form</a></li>
                        <li><a href="{{ route('pages.show', ['slug' => 'careers']) }}">Careers</a></li>
                        <li><a href="{{ asset('uploads/2026/2026/04/Active-agents.pdf') }}" target="_blank" rel="noopener noreferrer">List of Authorized Agents</a></li>
                        <li><a href="{{ asset('uploads/2024/2024/01/How-to-Launch-Complaints-and-Grievances-amended-as-per-18-1-24-2.pdf') }}" target="_blank" rel="noopener noreferrer">Grievance Handling Mechanism</a></li>
                        <li><a href="{{ asset('uploads/2024/2024/12/Compliance-Certificate-24-For-website.pdf') }}" target="_blank" rel="noopener noreferrer">Compliance Certificate</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-widget widget widget_text">
                    ...
                    <div class="textwidget">
                        <div class="laravel-footer-contact-item">
                            ...
                            <div>
                                <strong>For grievance handling: Mr. Iftikhar Ahmed</strong><br>
                                <strong>Email:</strong> <a href="mailto:grievance@5thpillartakaful.com">grievance@5thpillartakaful.com</a><br>
                                <strong>Contact:</strong> 021-36492847
                            </div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('uploads/2023/2023/08/email-64d5d36f518ed.webp') }}" alt="Email icon" width="30" height="30">
                            <div><strong>Email:</strong> <a href="mailto:info@5thpillartakaful.com">info@5thpillartakaful.com</a></div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('uploads/2023/2023/08/phone-64d5d36eb8358.webp') }}" alt="Phone icon" width="30" height="30">
                            <div><strong>UAN:</strong> 021-111-786-573</div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('uploads/2023/2023/08/location-64d5d36ec0e98.webp') }}" alt="Karachi office icon" width="30" height="30">
                            <div>Office No. SF-01 to SF-06, 2nd Floor, Emerald Mall, Near Do-Talwar, Clifton, Block 5, Karachi, Pakistan.</div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('uploads/2023/2023/08/location-64d5d36ec0e98.webp') }}" alt="Lahore office icon" width="30" height="30">
                            <div>Lahore Branch: Office No. 618 - 620, 6th Floor, Al-Hafeez Executive, 30-C-3, Gulberg III, Lahore, Pakistan.</div>
                        </div>
                        <div class="laravel-footer-hours">
                            <h5 style="font-size: 1.4rem;">Business Working Hours:</h5>
                            <p style="text-align: left; font-size: 14px; color: #b4a55c;">Monday to Friday: 9:00 AM to 5:00 PM</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-widget widget widget_text">
                    ...
                    <div class="textwidget laravel-footer-socials">
                        <p>
                            ...
                            <a class="footer-facebook" href="https://www.facebook.com/5thPillarTakaful/" target="_blank" rel="noopener noreferrer">Facebook</a>
                        </p>
                        <p>
                            <img src="{{ asset('uploads/2023/2023/08/linkedin-64d5d4a80599e.webp') }}" alt="Linkedin" width="30" height="30">
                            <a class="footer-linkedin" href="https://www.linkedin.com/company/5th-pillar-family-takaful-limited/" target="_blank" rel="noopener noreferrer">Linkedin</a>
                        </p>
                        <p>
                            <img src="{{ asset('uploads/2023/2023/08/instagram-64d5d4a764e3b.webp') }}" alt="Instagram" width="30" height="30">
                            <a class="footer-instagram" href="https://www.instagram.com/5thpillartakaful/" target="_blank" rel="noopener noreferrer">Instagram</a>
                        </p>
                        <p>
                            <img src="{{ asset('uploads/2023/2023/08/youtube-64d5d4a780967.webp') }}" alt="YouTube" width="30" height="30">
                            <a class="footer-youtube" href="https://www.youtube.com/@5thPillarFamilyTakafulLimited" target="_blank" rel="noopener noreferrer">YouTube</a>
                        </p>
                    </div>
                </div>
