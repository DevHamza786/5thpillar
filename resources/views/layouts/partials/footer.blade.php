            ...
            <div class="laravel-footer-grid">
                <div class="footer-widget widget widget_nav_menu">
                    ...
                    <ul class="menu">
                        ...
                        <li><a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/quick-links/Active-agents.pdf') }}" target="_blank" rel="noopener noreferrer">{{ __('List of Authorized Agents') }}</a></li>
                        <li><a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/quick-links/How-to-Launch-Complaints-and-Grievances-amended-as-per-18-1-24-2.pdf') }}" target="_blank" rel="noopener noreferrer">{{ __('Grievance Handling Mechanism') }}</a></li>
                        <li><a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/quick-links/Compliance-Certificate-24-For-website.pdf') }}" target="_blank" rel="noopener noreferrer">{{ __('Compliance Certificate') }}</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-widget widget widget_text">
                    ...
                    <div class="textwidget">
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('assets/images/footer/Person.png') }}" alt="Grievance contact icon" width="30" height="30">
                            <div>
                        ...
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('assets/images/footer/email-64d5d36f518ed.webp') }}" alt="Email icon" width="30" height="30">
                            <div><strong>{{ __('Email') }}:</strong> <a href="mailto:info@5thpillartakaful.com">info@5thpillartakaful.com</a></div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('assets/images/footer/phone-64d5d36eb8358.webp') }}" alt="Phone icon" width="30" height="30">
                            <div><strong>{{ __('UAN') }}:</strong> 021-111-786-573</div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('assets/images/footer/location-64d5d36ec0e98.webp') }}" alt="Karachi office icon" width="30" height="30">
                            <div>{{ __('Office No. SF-01 to SF-06, 2nd Floor, Emerald Mall, Near Do-Talwar, Clifton, Block 5, Karachi, Pakistan.') }}</div>
                        </div>
                        <div class="laravel-footer-contact-item">
                            <img src="{{ asset('assets/images/footer/location-64d5d36ec0e98.webp') }}" alt="Lahore office icon" width="30" height="30">
                ...
                <div class="footer-widget widget widget_text">
                    ...
                    <div class="textwidget laravel-footer-socials">
                        <p>
                            <img src="{{ asset('assets/images/footer/facebook-64d5d4a809c09.webp') }}" alt="Facebook" width="30" height="30">
                            <a class="footer-facebook" href="https://www.facebook.com/5thPillarTakaful/" target="_blank" rel="noopener noreferrer">{{ __('Facebook') }}</a>
                        </p>
                        <p>
                            <img src="{{ asset('assets/images/footer/linkedin-64d5d4a80599e.webp') }}" alt="Linkedin" width="30" height="30">
                        ...
                        <p>
                            <img src="{{ asset('assets/images/footer/instagram-64d5d4a764e3b.webp') }}" alt="Instagram" width="30" height="30">
                        ...
                        <p>
                            <img src="{{ asset('assets/images/footer/youtube-64d5d4a780967.webp') }}" alt="YouTube" width="30" height="30">
                ...
                <div class="footer-widget widget widget_text">
                    <div class="laravel-footer-badges">
                        <div class="laravel-footer-fio">
                            <img src="{{ asset('assets/images/footer/Logo-2-1-370x103.png') }}" alt="Federal Insurance Ombudsman Pakistan" width="370" height="103">
                        ...
                        <a href="http://jamapunji.pk/" target="_blank" rel="noopener noreferrer">
                            <img src="{{ asset('assets/images/footer/jamapunji_parkash_parmar-1.png') }}" alt="Jamapunji" width="461" height="109">
                        </a>
                        <a href="https://sdms.secp.gov.pk/" target="_blank" rel="noopener noreferrer">
                            <img src="{{ asset('assets/images/footer/SECP-Logo-Footer.webp') }}" alt="SECP SDMS" width="419" height="85">
                        </a>
