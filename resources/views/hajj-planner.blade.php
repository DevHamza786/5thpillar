...
@php
    ...
    $hpHomeRoute = $urduLocale->namedRoute('home');
    $hpCalcRouteHajj = $urduLocale->namedRoute('hajj-planner.calculate');
    $hpCalcRouteUmrah = $urduLocale->namedRoute('umrah-planner.calculate');
...
@push('head')
    @php
        $__hpCss = public_path('assets/css/pages/hajj-planner.css');
        $__hpCssVer = is_file($__hpCss) ? (string) filemtime($__hpCss) : '1';
    @endphp
    <link rel="stylesheet" href="{{ asset('assets/css/pages/hajj-planner.css') }}?v={{ $__hpCssVer }}">
@endpush
...
@push('scripts')
    @php
        $__plannerJs = public_path('assets/js/pages/planner-hajj-umrah.js');
        $__plannerJsVer = is_file($__plannerJs) ? (string) filemtime($__plannerJs) : '1';
    @endphp
    <script type="application/json" id="planner-page-config">{!! json_encode([
        'calculateUrlHajj' => route($hpCalcRouteHajj),
        'calculateUrlUmrah' => route($hpCalcRouteUmrah),
        'initialProduct' => $initialProduct,
        'pageTitleHajj' => __('Hajj Planner - 5th Pillar Family Takaful'),
        'pageTitleUmrah' => __('Umrah Planner - 5th Pillar Family Takaful'),
        'txtMastheadHajj' => __('Hajj Planner'),
        'txtMastheadUmrah' => __('Umrah Planner'),
        'txtYourHajjPlan' => __('Your Hajj Plan'),
        'txtYourUmrahPlan' => __('Your Umrah Plan'),
        'txtEstHajj' => __('Estimated cost of Hajj after'),
        'txtEstUmrah' => __('Estimated cost of Umrah after'),
        'yearsLabel' => __('Years'),
        'msgProcessing' => __('Processing...'),
        'msgCalculateHajj' => __('Calculate My Hajj Plan'),
        'msgCalculateUmrah' => __('Calculate Umrah Plan'),
