                            ...
                            <ul>
                                ...
                                <li class="laravel-sitemap__nest laravel-sitemap__nest--cols">
                                    ...
                                    <ul class="laravel-sitemap__nest-list">
                                        <li>
                                            <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/investors/Notice-of-AGM-2026.pdf') }}" target="_blank" rel="noopener noreferrer">Notice of AGM 2026</a>
                                        </li>
                                        <li>
                                            <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/investors/Notice-of-EoGM-2025.pdf') }}" target="_blank" rel="noopener noreferrer">Notice of EoGM 2025</a>
                                        </li>
                                        <li>
                                            <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/investors/Notice-of-AGM-2025.pdf') }}" target="_blank" rel="noopener noreferrer">Notice of AGM 2025</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="laravel-sitemap__nest laravel-sitemap__nest--cols">
                                    ...
                                    <ul class="laravel-sitemap__nest-list">
                                        <li>
                                            <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/funds/web-page.pdf') }}" target="_blank" rel="noopener noreferrer">Target Asset Mix and Charges</a>
                                        </li>
                    ...
                    <ul class="laravel-sitemap__col-list">
                        <li class="laravel-sitemap__block">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/company/IFS-Rating-of-5th-Pillar-Family-Takaful-Limited.pdf') }}" target="_blank" rel="noopener noreferrer">PACRA Rating</a>
                                </li>
                                <li>
                                    <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/company/Code-of-Conduct-Corporate.pdf') }}" target="_blank" rel="noopener noreferrer">Code of Conduct</a>
                                </li>
                                <li>
                                    <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/company/Waqf-Deed-with-addition-of-Amendment-2-4-26.pdf') }}" target="_blank" rel="noopener noreferrer">Waqf Deed</a>
                                </li>
                                <li>
                                    <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/company/PTF-Policies.pdf') }}" target="_blank" rel="noopener noreferrer">PTF Policies</a>
                                </li>
                        ...
                        <li class="laravel-sitemap__block">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ \App\Support\PublicPath::uploadHref('assets/pdf/investors/Unclaimed-Un-Enchased-Benefits-lIst-March-2026.pdf') }}" target="_blank" rel="noopener noreferrer">List of Participants Having Unclaimed / Un-Enchased Benefits</a>
                                </li>
